...
AgregarVariables  <- function( dataset )
{
  ...
  # 36 variables para hacer interacciones
  campos_buenos = c("internet","cliente_edad","cliente_antiguedad","mrentabilidad","mrentabilidad_annual","mcomisiones","mactivos_margen","mpasivos_margen","cproductos","mcuenta_corriente",
                    ...
                    "ctransferencias_recibidas","mtransferencias_recibidas","mtransferencias_emitidas","ccallcenter_trx","chomebanking_trx","ctrx_quarter","cmobile_app_trx" #7
                   )
...
p3  <- PARAM$tendenciaYmuchomas3
TendenciaYmuchomas( dataset, 
                     cols= cols_lagueables,
                     ventana=   p3$ventana,
                     tendencia= p3$tendencia,
                     minimo=    p3$minimo,
                     maximo=    p3$maximo,
                     promedio=  p3$promedio,
                     ratioavg=  p3$ratioavg,
                     ratiomax=  p3$ratiomax
)

p6  <- PARAM$tendenciaYmuchomas6
TendenciaYmuchomas( dataset, 
                    cols= cols_lagueables,
                    ventana=   p6$ventana,
                    tendencia= p6$tendencia,
                    minimo=    p6$minimo,
                    maximo=    p6$maximo,
                    promedio=  p6$promedio,
                    ratioavg=  p6$ratioavg,
                    ratiomax=  p6$ratiomax
)

p9  <- PARAM$tendenciaYmuchomas9
TendenciaYmuchomas( dataset, 
                    cols= cols_lagueables,
                    ventana=   p9$ventana,
                    tendencia= p9$tendencia,
                    minimo=    p9$minimo,
                    maximo=    p9$maximo,
                    promedio=  p9$promedio,
                    ratioavg=  p9$ratioavg,
                    ratiomax=  p9$ratiomax
)
