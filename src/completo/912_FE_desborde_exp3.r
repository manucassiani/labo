...
TendenciaYmuchomas4  <- function( dataset, cols, ventana=4, tendencia=TRUE, minimo=TRUE, maximo=TRUE, promedio=TRUE, 
...
#------------------------------------------------------------------------------
#calcula la tendencia de las variables cols de los ultimos 15 meses
#la tendencia es la pendiente de la recta que ajusta por cuadrados minimos
#La funcionalidad de ratioavg es autoria de  Daiana Sparta,  UAustral  2021

TendenciaYmuchomas15  <- function( dataset, cols, ventana=15, tendencia=TRUE, minimo=TRUE, maximo=TRUE, promedio=TRUE, 
                                 ratioavg=FALSE, ratiomax=FALSE)
{
  gc()
  #Esta es la cantidad de meses que utilizo para la historia
...
if( PARAM$tendenciaYmuchomas15$correr ) 
{
  p  <- PARAM$tendenciaYmuchomas15
  
  TendenciaYmuchomas15( dataset, 
                        cols= cols_lagueables,
                        ventana=   p$ventana,
                        tendencia= p$tendencia,
                        minimo=    p$minimo,
