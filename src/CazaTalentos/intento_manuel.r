...
Estrategia_B  <- function()
{
  ...
  planilla_cazatalentos[ ids_juegan1,  tiros1 := 30 ]  #registro en la planilla que tiran 70 tiros
  resultado1  <- gimnasio_tirar( ids_juegan1, 30)
  ...
  mediana  <- planilla_cazatalentos[ ids_juegan1, quantile(aciertos1, prob=c(0.60)) ]
  ids_juegan2  <- planilla_cazatalentos[ ids_juegan1 ][ aciertos1 >= mediana, id ]
  
  planilla_cazatalentos[ ids_juegan2,  tiros2 := 65 ]  #registro en la planilla que tiran 70 tiros
  ...
  #A la mitad mejor la hago tirar 70 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  mediana  <- planilla_cazatalentos[ ids_juegan2, mean(aciertos2) ]
  ids_juegan3  <- planilla_cazatalentos[ ids_juegan2 ][ aciertos2 >= mediana, id ]
  
  planilla_cazatalentos[ ids_juegan3,  tiros3 := 90 ]  #registro en la planilla que tiran 70 tiros
  resultado3  <- gimnasio_tirar( ids_juegan3, 90)
  ...
  planilla_cazatalentos[ ids_juegan4,  tiros4 := 130 ]  #registro en la planilla que tiran 70 tiros
  resultado4  <- gimnasio_tirar( ids_juegan4, 130)
  ...
  planilla_cazatalentos[ ids_juegan5,  tiros5 := 200 ]  #registro en la planilla que tiran 70 tiros
  ...
  planilla_cazatalentos[ ids_juegan6,  tiros6 := 250 ]  #registro en la planilla que tiran 70 tiros
  resultado6  <- gimnasio_tirar( ids_juegan6, 250)
