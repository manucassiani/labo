...
hs <- makeParamSet( 
  ...
  makeIntegerParam("min_data_in_leaf", lower=  2500    , upper= 12000),
  makeIntegerParam("num_leaves",       lower= 16L   , upper= 500L),
  makeNumericParam("prob_corte",       lower= 0.0001 , upper=  0.012),  #esto sera visto en clase en gran detalle
  makeNumericParam("lambda_l1",        lower=  0    , upper=   200),
  makeNumericParam("lambda_l2",        lower=  0    , upper=   200),  
  makeNumericParam("max_depth",        lower=  4L    , upper=   20L),
  makeNumericParam("max_bin",        lower=  31L    , upper=   300L),
  makeNumericParam("min_gain_to_split",        lower=  0    , upper=   200),    
)

ksemilla_azar  <- 999007  #Aqui poner la propia semilla
