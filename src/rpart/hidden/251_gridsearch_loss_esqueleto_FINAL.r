...
pb = txtProgressBar(min = 1, max = 60, style = 3)
...
for( vmax_depth  in  c( 4, 6, 8, 10)  )
{
  print("max_depth = ");
  print(vmax_depth);
for( vmin_split  in  c(60,100,400,1000)  )
{
  print("min_split = ");
  print(vmin_split);  
for( vmin_bucket in c(20, 30, 50, 200, 500) )
{
  print("min_bucket = ");
  print(vmin_bucket);
for( vpeso_error  in  c(-1 ,1, 10, 20, 40, 60,1000,60000) )
{
