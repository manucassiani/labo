...
ksemilla_azar  <- 200001   #cambiar por la primer semilla
...
setwd("/home/manuel/Escritorio/ITBA/03-Minería_de_Datos/01-GIT/labo/exp/HT3210/")   #Establezco el Working Directory DEL EXPERIMENTO
