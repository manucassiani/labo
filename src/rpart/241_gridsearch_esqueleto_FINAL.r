...
pb = txtProgressBar(min = 10, max = 1200, style = 3)
...
{ print("cp = ");
  print(vcp);
for( vmin_bucket in c(2400, 2000, 1600, 1200, 800, 400, 200, 100, 40, 20) )
{ print("min_bucket = ");
  print(vmin_bucket);
for( vmin_split  in  c(10,20,50,100,200,400,600,800,1000,1200) )
{ #pb$tick();
