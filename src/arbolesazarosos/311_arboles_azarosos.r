...
feature_fraction  <-   0.2  #entreno cada arbol con solo 50% de las variables variables

set.seed(200001) #Establezco la semilla aleatoria, cambiar por SU primer semilla
...
pdf( "./labo/exp/KA2101/arbolitos3.pdf", paper="a4r" )
...
fwrite( tb_ensembles,
        file="./labo/exp/KA2101/ensemble3.csv",
        sep="\t" )
...
fwrite( entrega, 
        file= "./labo/exp/KA2101/K311_006.csv", 
        sep= "," )
