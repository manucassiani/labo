...
EstimarGanancia_xgboost  <- function( x )
{
  ...
  modelocv  <- xgb.cv( objective= "binary:logistic",
                       ...
                       nrounds= 100,        #un numero muy grande, lo limita early_stopping_rounds
...
setwd("/home/manuel/Escritorio/ITBA/03-Minería_de_Datos/01-GIT/labo/exp/HT5720/")   #Establezco el Working Directory DEL EXPERIMENTO
