...
ksemilla_azar  <- 200007  #Aqui poner la propia semilla
...
setwd("/home/manuel/Escritorio/ITBA/03-Minería_de_Datos/01-GIT/labo/exp/HT5620/")   #Establezco el Working Directory DEL EXPERIMENTO
